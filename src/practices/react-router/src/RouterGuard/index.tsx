...
interface RouterGuardProps extends RouteComponentProps {
  when: boolean;
  navigate: (
    commonRouterProps: CommonRouterProps,
...
const RouterGuard = withRouter((props: RouterGuardProps) => {
  ...
  const [nextLocation, setNextLocation] = useState<
    CommonRouterProps["location"] | undefined
  >();
...
export const RouterGuardDemo = () => {
  ...
  const navigateCallback = useCallback<RouterGuardProps["navigate"]>(
    ({ history }, nextLocation, curLocation) => {
  ...
  return (
    <>
      ...
      <Router>
        <RouterGuard
          when={true}
          // navigate={({ history }, nextLocation, curLocation) => {
          //   if (curLocation.pathname !== nextLocation.pathname) {
          //     history.push(nextLocation.pathname);
          //     return;
          //   }
